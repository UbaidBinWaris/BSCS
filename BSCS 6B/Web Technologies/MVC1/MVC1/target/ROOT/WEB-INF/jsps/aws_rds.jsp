...
<%
    ...
    String mdContent = "";
    try {
        // Load aws_rds_ec_2_setup.md from webapp directory
        InputStream is = application.getResourceAsStream("/aws_rds_ec_2_setup.md");
        if (is != null) {
            ...
            mdContent = "Error: aws_rds_ec_2_setup.md file not found in webapp directory. Please place your AWS RDS guide at /aws_rds_ec_2_setup.md";
        }
    } catch (Exception e) {
...
<title>AWS RDS & EC2 Setup - MVC1 Web Application</title>
...
<body>
    ...
    <div class="container">
        <div class="markdown-body" id="content">
            <div class="loading">Loading AWS RDS & EC2 setup guide...</div>
        </div>
    </div>
